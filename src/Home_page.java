...
public class Home_page {
	...
	Home_page() {
		...
		// ------------------------Create Bill BUTTON---------------------------------
				...
				JButton create_bill = new JButton("Create Bill");
				create_bill.setForeground(new Color(0, 0, 205));
				create_bill.setBackground(new Color(224, 255, 255));
				create_bill.setBounds(260, 500, 204, 83);
				...
				create_bill.setBorder(BorderFactory.createBevelBorder(0, Color.BLACK, Color.black));
