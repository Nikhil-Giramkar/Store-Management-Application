		  	...
		  	public void actionPerformed(ActionEvent e) {
		  		...
		  		if(sellId.length()==0)
		  			...
		  			try {
		  				...
		  				Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/store_management_project","root","12345");
		  		
		  				 Statement stmt = connection.createStatement();

		    		      String sql = "SELECT prodName, pricePerItem, qtyBought, amount FROM Sell where prodId='"+prodId+"' and sellId='"+sellId+"'";
		  ...
		  submit.addActionListener(new ActionListener() {
		  	public void actionPerformed(ActionEvent e) {
		  		...
		  		String sellId = SELLID.getText();
		  			...
		  			PreparedStatement sta = connection.prepareStatement("DELETE from Sell where prodId = ? and sellId=?");
