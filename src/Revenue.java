	...
	Revenue() {
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 * DriverManager.getConnection("jdbc:mysql://localhost:3306/student_teacher_app"
				 * ,"root","12345");
				 * 
				 * PreparedStatement sta = connection.
				 * prepareStatement("insert into student_teacher_gui values(?,?,?,?,?,?,?)");
				 * sta.setString(1, full_name); sta.setInt(2, roll_no); sta.setString(3,
				 * residence); sta.setString(4, Gender); sta.setString(5, BG); sta.setString(6,
				 * Rh); sta.setString(7, designation);
				 * 
				 * sta.executeUpdate(); JOptionPane.showMessageDialog(submit,
